...
```sh
npm install -g @aziron-ai/atlas@0.1.46
```
...
```sh
# Debian or Ubuntu
sudo dpkg -i atlas_0.1.46_linux_amd64.deb

# Fedora or RHEL
sudo rpm -U atlas_0.1.46_linux_amd64.rpm

# Alpine
sudo apk add --allow-untrusted atlas_0.1.46_linux_amd64.apk
```
