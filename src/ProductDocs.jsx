        ...
        <>
          ...
          <ProseSection title="Symptom to Action">
            ...
            <div className="docs-table-wrap"><table><thead><tr><th>Symptom</th><th>Action</th></tr></thead><tbody>
              ...
              <tr><td>Retrieval reports <code>sql_fallback</code></td><td>The lexical (BM25) sidecar is empty or wedged while the graph stays readable. Run <code>atlas doctor</code> to confirm, stop other Atlas processes, then <code>atlas compact --rebuild-lexical</code> and re-check <code>atlas status</code></td></tr>
